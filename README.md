...
**Not included in this repo (too large / contain sensitive data):**
- `efficientnet_stage2_best.keras` — trained model weights (place next to app.py before running)
- `shap_background.npy` — SHAP background array (generated by save_shap_background.py)
- `breastai.db` — created automatically on first run
- `.env` — you create this yourself (see setup below)
